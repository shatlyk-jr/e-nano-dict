List<String> definitions = [
  ...
  "Bits per inch - measurement of bit density",
  ...
  "Any nonprogrammable large memory.",
  ...
  "See Nitrile-Butadiene Rubber and Styrene-Butadiene Rubber.",
  ...
  "In a linear polymer, the number of monomer structural units.",
  ...
  "Raychem?s registered trade name for coaxial cables.",
  ...
  "The DC resistance, in ohms, of the coil at 25?C.",
  ...
  "Any material composed of more than one element type.",
  ...
  "A plastic to which conductive fillers have been added.",
  ...
  "The information contained in any storage medium.",
  ...
  "Abbreviation for electron-coupled oscillator.",
  ...
  "A braided shield composed of flat strands.",
  "A cable with each component in a single, flat plane.",
  ...
  "A copper or brass terminal nickel plated to withstand 650?F.",
  ...
  "A 12-bit code used for recording characters in punched cards.",
  "A terminal with a tongue that is open from the side rather than from the end.",
  "Wiring used to connect various points in electronic assemblies.",
  ...
  "Any gap between the interface of mated connectors.",
  ...
  "ID - The inside or internal diameter of a tubing.",
  ...
  "Kodak photo resist. See also KMER.",
  ...
  "Kilovolt - A unit equal to 1000 volts.",
  ...
  "The route the magnetic flux 'flows' in a magnetic circuit.",
  ...
  "The manner in which a failure occurs. Reason for which a converter either does not meet or stops meeting its specified parameters.",
  "A unit that transmits signals over a telephone line.",
  ...
  "More than one component within a single-cable complex.",
  ...
  "A combination of two or more components cabled together.",
  ...
  "(VIL min VOL max) or (VOH min VIH max) which ever lowest.",
  ...
  "Offset quadrature phase shift key modulation.",
  ...
  "The number of parts per unit volume.",
  ...
  "Pulse-coupled complementary logic.",
  ...
  "The number of crossovers of braiding units per inch of cable.",
  "The minimum value which will energize the contacts of a relay.",
  "A prefix meaning 10-12, or one trillionth, abbreviated as 'p.'",
  ...
  "The act of surface preparation before encapsulating.",
  "Usually, the solder ring in a SolderSleeve device.",
  ...
  "Symbol used to denote resistance in ohms.",
  "The maximum resistance of a PolySwitch device at room temperature one hour after being tripped or after reflow soldering.",
  ...
  "A filter made of resistor and capacitor",
  "Designation for any resistor-capacitor circuit.",
  ...
  "Selective Access or Selective Availability",
  ...
  "An IBM data-communication protocol.",
  ...
  "In parallel with; connector used to common two circuits.",
  ...
  "A conductor composed of one single strand.",
  ...
  "An optical pulse that does not disperse over distance.",
  ...
  "A terminal with a slotted tongue that has nearly square sides.",
  ...
  "Extra inputs or unused inputs",
  "A disruptive discharge between electrodes of a measuring gap",
  ...
  "The feel or snap action of certain constructions of keyboards.",
  ...
  "A part of a fiber-optic connector analagous to a contact.",
  "A resin formed by three separate monomers polymerized together.",
  ...
  "The capacitance between trace to reference plane",
  ...
  "The time needed, from the onset of a fault current, to trip a PolySwitch device. For any particular type of PolySwitch device, trip time depends upon the size of the fault current and the ambient temperature. The higher the fault current and/or the higher the temperature, the shorter the trip time.",
  "Tri-State buffer is a buffer that can be either input or output",
  ...
  "used to connect traces between two or more layers",
  ...
  "Letter symbol used to represent reactance in ohms.",
  ...
  "Letter symbol used to represent impedance in ohms.",
  ...
  "The elimination of nonsignificant zeros in a numeral.",
